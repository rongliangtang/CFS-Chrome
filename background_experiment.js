...
importScripts("lib/cryptojs/cryptojs-aes_0.2.0.min.js", "lib/cryptojs/cryptojs-mode-ctr_0.2.0.min.js", "lib/cryptojs/all_0.2.0.min.js", "lib/cryptojs/cryptojs-mode-ecb_0.2.0.min.js", "utils/code.js", "utils/other.js", "cfs/securefs.js");
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.type === 'experiment') {
    const {filename_key, content_key, url} = message;
    console.log(message);
    fetchAndProcessFile(filename_key, content_key, url);
  }
});
